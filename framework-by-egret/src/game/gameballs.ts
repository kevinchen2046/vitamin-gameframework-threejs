class GameBalls extends vitamin.GameBase {
    ...
    constructor(renderer: THREE.WebGLRenderer) {
        ...
        fbxloader.load('resource/source/succulents.fbx', (object: THREE.Object3D) => {
    ...
    public resize(width: number, height: number) {
        ...
        this.camera.zoom = Math.min(1, width / vitamin.context.designWidth);
